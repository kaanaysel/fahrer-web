...
@media(min-width:901px){.table-wrap.mobile-cards{max-height:calc(100vh - 230px);overflow:auto;position:relative}.months-table th,.payroll-table th{position:sticky;top:0;z-index:20;background:#f3f6fb}.months-table th:last-child,.months-table td:last-child{position:sticky;right:0;z-index:18;box-shadow:-10px 0 14px rgba(16,24,40,.08)}.months-table th:last-child{z-index:30;background:#f3f6fb}.months-table td:last-child{background:#fff}.months-table .row-alt td:last-child{background:#f3f6fb}.months-table .row-base td:last-child{background:#fff}.months-table tr:hover td:last-child{background:#eaf1fb!important}.payroll-table th:last-child,.payroll-table td:last-child{position:sticky;right:0;z-index:18;box-shadow:-10px 0 14px rgba(16,24,40,.08)}.payroll-table th:last-child{z-index:30;background:#f3f6fb}.payroll-table td:last-child{background:#fff}.payroll-table .row-alt td:last-child{background:#f3f6fb}.payroll-table .row-base td:last-child{background:#fff}}
...
def admin_payroll_hours():
    ...
    <div class="card"><h2>Stunden für Lohnabrechnung – {{ months[month] }} {{ year }}</h2>
      ...
      <tr class="driver-row {{ 'row-alt' if loop.index0 % 2 else 'row-base' }}">
        ...
        <td data-label="geleistete Stunden"><form method="post" id="payroll-{{ d['id'] }}"><input type="hidden" name="action" value="save"><input type="hidden" name="driver_id" value="{{ d['id'] }}"><input name="worked_hours" value="{{ r['worked_hours'] if r else '' }}"></form></td>
